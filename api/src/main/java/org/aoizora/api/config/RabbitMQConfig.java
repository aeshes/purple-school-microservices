...
public class RabbitMQConfig {
    ...
    @Bean
    public Queue userInfoReplyQueue() {
        return QueueBuilder.durable(USER_INFO_REPLY_QUEUE).build();
    }
    ...
    @Bean
    public Binding userInfoReplyBinding() {
        return BindingBuilder
                .bind(userInfoReplyQueue())
                .to(authExchange())
                .with(USER_INFO_REPLY_ROUTING_KEY);
    }
